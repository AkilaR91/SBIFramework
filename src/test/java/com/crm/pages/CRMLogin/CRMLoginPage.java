...
public class CRMLoginPage extends TestListeners
{
	...
	public void adminLogInLogout() throws Exception{
		CommonMethods.highLight("adminProfileImage_XPATH");
		CommonMethods.Click("adminProfileImage_XPATH");
		CommonMethods.highLight("adminLogoutBtn_XPATH");
		CommonMethods.Click("adminLogoutBtn_XPATH");
		log.info("Sucessfully logout..");
